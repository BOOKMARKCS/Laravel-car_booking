...
@section('content')
    ...
    <div class="row justify-content-center">
        ...
        <div class="min-w-screen min-h-screen flex items-top justify-center  font-sans overflow-hidden">
                    ...
                    <table class="min-w-max w-full table-auto">
                        <thead>
                            <tr class="bg-gray-200 text-gray-600 uppercase text-sm leading-normal">
                                ...
                                <th class="py-3 px-6 text-center">Return time</th>
                                <th class="py-3 px-6 text-center">passengers</th>
                                ...
                                <tr class="border-b border-gray-200 hover:bg-gray-100">
                                    ...
                                    <td class="py-3 px-6 text-center">
                                        <div class="flex items-center justify-center">
                                            ...
                                            <div class="w-4 mr-2 transform hover:text-purple-500 hover:scale-110">
                                                <button class="mt-1 py-0" type="submit">
