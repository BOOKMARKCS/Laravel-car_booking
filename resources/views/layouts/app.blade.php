...
<body class="bg-slate-200 ">
    <div id="app">
        ...
        <div class="fixed h-full w-full -z-0">
            <div id="sidebar" class=" h-full w-64   max-sm:w-1/6 max-lg:w-24  bg-sky-500 transition-all duration-500 ">
                ...
                <div>
                    <div class="items-center">
                        ...
                        <ul class="mt-2 justify-center flex flex-col gap-1">
                                ...
                                <a href="{{route('home')}}" class="text-slate-200 hover:text-white w-100 text-base">
                                    <div class="flex h-12 items-center justify-center lg:mx-6 max-lg:m-1 max-lg:p-1 lg:py-1  hover:bg-blue-700 hover:font-bold hover:text-lg rounded-lg  gap-3 hover:h-14 hover:duration-500 {{ 'home' == request()->path()? 'bg-blue-900 text-white font-bold ':''}}">
                                        <svg class="h-full" viewBox="0 0 24 24">
                                            ...
                                            <path class="fill-current text-slate-400 {{ 'home' == request()->path()? 'bg-blue-900 text-white font-bold ':''}}" d="M12 15c-1.654 0-3-1.346-3-3 0-.462.113-.894.3-1.285L6 6l4.714 3.301A2.973 2.973 0 0112 9c1.654 0 3 1.346 3 3s-1.346 3-3 3z">
                                            </path>
                                        </svg>
                                ...
                                <a href="{{ route('profile') }}" class="text-slate-200 hover:text-white text-base">
                                    <div class="flex items-center h-12 justify-center lg:mx-6 max-lg:m-1 max-lg:p-1  hover:bg-blue-700 hover:font-bold hover:text-lg lg:p-2 rounded-lg  gap-3 hover:h-14 hover:duration-500  {{ 'profile' == request()->path()? 'bg-blue-900 text-white font-bold ':''}}">
                                        <svg class="h-full" viewBox="0 0 24 24">
                                            ...
                                            <path class="fill-current text-slate-400 {{ 'profile' == request()->path()? 'bg-blue-900 text-white font-bold ':''}} false" d="M12 6a3 3 0 110-6 3 3 0 010 6zm2 18h-4a1 1 0 01-1-1v-6H6v-6a3 3 0 013-3h6a3 3 0 013 3v6h-3v6a1 1 0 01-1 1z">
                                            </path>
                                        </svg>
                                ...
                                <a href="{{ route('booking') }}" class="text-slate-200 hover:text-white text-base ">
                                    <div class="flex items-center h-12 justify-center lg:mx-6 max-lg:m-1 max-lg:p-1 lg:p-2 hover:bg-blue-700 hover:font-bold hover:text-lg p-2 rounded-lg  gap-3 hover:h-14 hover:duration-500 {{ 'booking' == request()->path()? 'bg-blue-900 text-white font-bold ':''}}">
                                        <svg class="h-full" viewBox="0 0 24 24">
                                            ...
                                            <path class="fill-current text-slate-600 {{ 'booking' == request()->path()? 'bg-blue-900 text-white font-bold ':''}} false" d="M6.939 15.007A5.861 5.861 0 0 1 6 11.829c0-2.937 2.167-5.376 5-5.85V0C4.85.507 0 5.614 0 11.83c0 2.695.922 5.174 2.456 7.17l4.483-3.993Z">
                                            </path>
                                        </svg>
                            ...
                            <li>
                                <a href="{{ route('status') }}" class="text-slate-200 hover:text-white text-base">
                                    <div class="flex items-center h-12 justify-center lg:mx-6 max-lg:m-1 max-lg:p-1 lg:p-2 hover:bg-blue-700 hover:font-bold hover:text-lg p-2 rounded-lg  gap-3 hover:h-14 hover:duration-500 {{ 'status' == request()->path()? 'bg-blue-900 text-white font-bold ':''}}">
                                        <svg class="h-full" viewBox="0 0 24 24">
                                            ...
                                            <path class="fill-current text-slate-400 {{ 'status' == request()->path()? 'bg-blue-900 text-white font-bold ':''}} false" d="M15 10.586L16.414 12 11 17.414 7.586 14 9 12.586l2 2zM5 0h14v4H5z">
                                            </path>
                                        </svg>
                            ...
                            <li>
                                <a aria-current="page" class="text-slate-200 hover:text-white text-base" href="{{route('history')}}">
                                    <div class="flex items-center h-12 justify-center lg:mx-6 max-lg:m-1 max-lg:p-1 lg:p-2 hover:bg-blue-700 hover:font-bold hover:text-lg rounded-lg  gap-3 hover:h-14 hover:duration-500 {{ 'history' == request()->path()? 'bg-blue-900 text-white font-bold ':''}}">
                                        <svg class="h-full" viewBox="0 0 24 24">
                                            ...
                                            <path class="fill-current text-slate-400 {{ 'history' == request()->path()? 'bg-blue-900 text-white font-bold ':''}} false" d="M21 3h2v4H1V3h2V1h4v2h10V1h4v2Z"></path>
                                        </svg>
                            ...
                            <li>
                                <a href="{{ route('manager') }} " class="text-slate-200 hover:text-white text-base">
                                    <div class="flex items-center h-12 justify-center lg:mx-6 max-lg:m-1 max-lg:p-1 lg:p-2 hover:bg-blue-700 hover:font-bold hover:text-lg  rounded-lg  gap-3 hover:h-14 hover:duration-500 {{ 'manager' == request()->path()? 'bg-blue-900 text-white font-bold ':''}}">
                                        <svg class="h-full" viewBox="0 0 24 24">
                                            <circle class="fill-current text-slate-400{{ 'manager' == request()->path()? 'bg-blue-900 text-white font-bold ':''}} false" cx="18.5" cy="5.5" r="4.5"></circle>
                                            ...
                                            <circle class="fill-current text-slate-400 {{ 'manager' == request()->path()? 'bg-blue-900 text-white font-bold ':''}} false" cx="5.5" cy="18.5" r="4.5"></circle>
                                        </svg>
                                ...
                                <a aria-current="page" class="text-slate-200 hover:text-white text-base" href="{{ route('contact') }}">
                                    <div class="flex items-center h-12 justify-center lg:mx-6 max-lg:m-1 max-lg:p-1 lg:p-2 hover:bg-blue-700 hover:font-bold hover:text-lg  rounded-lg  gap-3 hover:h-14 hover:duration-500 {{ 'contact' == request()->path()? 'bg-blue-900 text-white font-bold ':''}}">
                                        <svg class="h-full" viewBox="0 0 24 24">
                                            ...
                                            <path class="fill-current text-slate-400 {{ 'contact' == request()->path()? 'bg-blue-900 text-white font-bold ':''}} false" d="M11 1C5.477 1 1 4.582 1 9c0 1.797.75 3.45 2 4.785V19l4.833-2.416C8.829 16.85 9.892 17 11 17c5.523 0 10-3.582 10-8s-4.477-8-10-8z">
                                            </path>
                                        </svg>
        ...
        <!-- Content -->
        <div class="flex z-0">
            <div class=" h-screen  w-64 max-sm:w-1/6 max-lg:w-24 lg:sidebar-expanded:!w-64 2xl:!w-64 shrink-0 transition-all duration-200 ">

            </div>
            <div class="min-h-full w-100 overflow-x-hidden">
                <nav class="bg-white">
                    <div class="mx-auto  px-14 sm:px-6 lg:px-12">
                                        ...
                                        <div class="">
                                            ...
                                            <div class="absolute mt-2">
                                                <div class="dropdown-menu" role="menu" aria-labelledby="user-menu-button">
                                                    ...
                                                    <a href="{{route('logout')}}" onclick="event.preventDefault(); document.getElementById('logout-form').submit();" class="block px-4 py-2 text-sm text-gray-700" role="menuitem" tabindex="-1" id="user-menu-item-2">Sign out
